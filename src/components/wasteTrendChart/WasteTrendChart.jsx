...
const WasteTrendChart = ({ data = [] }) => {
    ...
    const tickColor = getCSSVar('--neutral-750');
    const lineColor = getCSSVar('--primary-500');
    const markStroke = getCSSVar('--white');
    ...
    return (
        <div className="waste-trend-container">
                ...
                >
                    <defs>
                        <linearGradient id="gradient" x1="0" x2="0" y1="0" y2="1">
                            <stop offset="0%" stopColor={getCSSVar('--primary-200')} stopOpacity={0.4} />
                            <stop offset="100%" stopColor={getCSSVar('--primary-200')} stopOpacity={0.05} />
                        </linearGradient>
                    </defs>
                </LineChart>
            </div>
            ...
            <div className="waste-trend-footer">
                <div className="waste-trend-legend"></div>
            </div>
        </div>
    );
};
